...
@Component({
  selector: 'app-wavier-form',
  templateUrl: './wavier-form.component.html',
  styleUrls: ['./wavier-form.component.scss'],
})
export class WavierFormComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* -------------------------  Lifecycle Hooks  --------------------------*//
  ngOnInit(): void {
    this._headerTitle.setTitle('Industrial / Service Sector Tour - Participation Approval and Waiver Form');
    ...
    this.data_sharing.updateAuditTrailData('wavier_form');
