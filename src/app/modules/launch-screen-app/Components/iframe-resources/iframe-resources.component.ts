...
@Component({
  selector: 'app-iframe-resources',
  templateUrl: './iframe-resources.component.html',
  styleUrls: ['./iframe-resources.component.scss'],
})
export class IframeResourcesComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  //* -----------------------  Variable Declaration  -----------------------*//
   ...
   iframeSource: string = 'https://p19.getwow.community';
  ...
  constructor(
    ...
    public _dialogRef: MatDialogRef<IframeResourcesComponent>,
