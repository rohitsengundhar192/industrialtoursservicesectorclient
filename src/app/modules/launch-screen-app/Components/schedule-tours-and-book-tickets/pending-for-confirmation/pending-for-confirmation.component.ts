...
import { ScheduleNewComponent } from './popup/schedule-new/schedule-new.component';
import { MatDialog } from '@angular/material/dialog';
import { RequestConfirmationComponent } from './popup/request-confirmation/request-confirmation.component';
import { TestingComponent } from '../../../Industrial-Service-Sector-Tours/testing/testing.component';
import { ApiService } from 'src/app/shared/services/api/api.service';
import { ScheduleEditComponent } from './popup/schedule-edit/schedule-edit.component';
import { DataSharingService } from 'src/app/shared/services/data-sharing/data-sharing.service';

@Component({
  selector: 'app-pending-for-confirmation',
  templateUrl: './pending-for-confirmation.component.html',
  styleUrls: ['./pending-for-confirmation.component.scss'],
})
export class PendingForConfirmationComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
  ...
  RadioBtnData(e: any) {
    ...
    this.rowvalues = e;
    if (this.rowValue != undefined) {
      this.btndisable = false;
      this.ticket_for_industrial_tour_site_id =
        e.ticket_for_industrial_tour_site_id;
      this.industrial_tour_trip_schedule_id =
        e.industrial_tour_trip_schedule_id;
      this.tables = [];
    }
  }
  filterValue = '';
  ...
  //* ------------------------------ Helper Function -----------------------*//
  scheduleNew() {
    const dialogRef = this.dialog.open(ScheduleNewComponent, {
      width: '800px',
      height: '600px',
  ...
  requestConfirmationDialogue() {
    const dialogRef = this.dialog.open(RequestConfirmationComponent, {
      width: '600px',
      height: '400px',
      disableClose: true,
      // data: this.selectCategory(),
