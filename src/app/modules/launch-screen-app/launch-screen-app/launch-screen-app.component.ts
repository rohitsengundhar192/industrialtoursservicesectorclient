...
export class LaunchScreenAppComponent implements OnInit, OnDestroy {
  ...
  menu = [
    {
      label: 'Industrial / Service Sector Tours - Guidelines',
      link: '/launch-screen/guidelines',
    },
    {
      label: 'Industrial / Service Sector Tour Sites',
      link: '/launch-screen/tour-sites',
    },
    {
      label: 'Industrial / Service Sector Tour - Participation Certificate',
      link: '/launch-screen/participation-certificate',
    },
    {
      label:
        'Industrial / Service Sector Tour - Participation Approval and Waiver Form',
      link: '/launch-screen/wavier-form',
    },
    {
      label: 'Book Industrial Tour Tickets',
      link: '/launch-screen/book-industrial-tour-ticket',
    },

    {
      label: 'Schedule Tours and Book Tickets',
      link: '/launch-screen/schedule-tours-and-book-tickets',
    },
    {
      label: 'Validate Completed Tour Photos and Rate your Experience',
      link: '/launch-screen/validate-complete-tour',
    },
    // {
    //   label: 'Testing',
    ...
    // {
    //   label: 'Image-service',
    //   link: '/launch-screen/image-slider',
    // },
  ];
